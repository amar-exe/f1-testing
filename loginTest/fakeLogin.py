...
username_element.send_keys("@stu.ibu.edu.ba@"+USERNAME)
...
error_element = driver.find_elements(by=By.XPATH,value='/html/body/div[2]/main/div/div[3]/div/form/div[1]/span')[0].text
print(error_element)
if error_element!="There was a problem with your password or email address. Please check your details and try again.":
    print("fejlo prvi")
...
password_element.send_keys(PASSWORD+"@stu.ibu.edu.ba@")
error_element=""
sign_in = driver.find_elements(by=By.XPATH, value='/html/body/div[2]/main/div/div[3]/div/form/div[4]/button')[0].click()
time.sleep(random.randint(4, 6))
error_element = driver.find_elements(by=By.XPATH,value='/html/body/div[2]/main/div/div[3]/div/form/div[1]/span')[0].text
